...
| 24-09-2026 | `b15de4d` | GEO en landings: definición "¿Qué es…?" justo bajo el hero (13 landings); H2 de definición en empresas e impuesto predial; `FAQPage` generado desde la FAQ visible también en la plantilla ServicePage; title ≤ 60 y meta description ≤ 155 en 11 páginas de /tasaciones | ✅ 24-09 (Sonnet): 21 páginas en 200, un h1 cada una; definición arriba y sin duplicar; FAQPage = FAQ visible (texto y cantidad) en las 18 landings y páginas de servicio; Service con url; /tasaciones dentro de los límites | Definición como 4.º H2 de 8; FAQPage con 4–5 preguntas frente a 6 visibles en embarcaciones e impuesto predial; 11 metas de 175–254 caracteres cortadas en la SERP | **25-10-2026** · Métrica: CTR de las 11 páginas en GSC (misma posición, mayor CTR) y menciones en respuestas de IA |
| 24-09-2026 | `492da97` + `e04f9b2` | Saneamiento inmobiliario: definición "¿Qué es el saneamiento inmobiliario o físico-legal?" arriba + bloque SEO (trámites, cuándo conviene, enlaces a judicial, impuesto predial y auditoría de planos); FAQ sin repetir la definición. Home: `FAQPage` de sus 6 preguntas. Silo /servicios: title ≤ 60 y meta ≤ 155 (6 páginas + índice) | ✅ 24-09 (Sonnet): 9 páginas en 200, un h1; FAQPage = FAQ visible en todas; enlaces de saneamiento en 200; definición sin duplicar | Saneamiento sin definición ni texto SEO (única landing así); home con 6 preguntas visibles sin schema; metas de /servicios de 186–229 caracteres | **25-10-2026** · Métrica: impresiones de saneamiento en GSC para "saneamiento físico legal" / "saneamiento inmobiliario"; CTR del silo /servicios |
